...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/13 16:27:35 by sanoor            #+#    #+#             */
/*   Updated: 2024/03/13 16:27:38 by sanoor           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cmd_node	*cmd_data(char *full_line, char **cmd)
{
	...
	if (!new_node->full_line && full_line)
	{
		free(new_node);
		return (NULL);
	}
...
void	*pipex_exit(t_cmd_data *d, char *param, int err, char ***cmd)
{
	if (param || err < 1)
